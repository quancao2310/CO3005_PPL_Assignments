...
class Frame():
    ...
    *   This method will create 2 new labels that represent the starting and ending points of the scope.
    ...
    *   This method creates 2 new labels that represent the starting and ending label of the loop.
